...
public class BetterStrategy {
    ...
    public static class Builder {
        ...
        public Builder setDiscoveryMode(int var1) {
            this.discoveryMode = var1;
            return this;
        }

        public Builder setDiscoveryMedium(int var1) {
            this.discoveryMedium = var1;
            return this;
        }

        public Builder setTtlSeconds(int var1) {
        ...
        public Builder setDistanceType(int var1) {
