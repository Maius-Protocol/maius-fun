const Privacy = () => {
  return (
    <div>
      ...
      <p>
        (TEAM MAIUS) TUNG HOANG SON built the Maius Fun app as a Free app. This
        SERVICE is provided by TUNG HOANG SON at no cost and is intended for use
        as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Maius Fun unless otherwise
      ...
      <p>
        ...
        but not limited to TUNG HOANG SON. The information that I request will
      ...
      <p>This policy is effective as of 2023-03-06</p>{' '}
      <p>
        <strong>Contact Us</strong>
      </p>{' '}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at contact@megatunger.com.
      </p>{' '}
      <p>
